...
public class TeacherManager implements AuthenticationProvider, InitializingBean {
	...
	private TeacherAuthenticationToken getAuthenticationToken(String id) {
		...
		return TeacherAuthenticationToken.builder().principal(teacher).details(teacher.getUsername())
	...
	public void afterPropertiesSet() throws Exception {
		Set.of(new Teacher("choi", "최선생", Set.of(new SimpleGrantedAuthority("ROLE_TEACHER"))))
